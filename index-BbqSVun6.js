...
` + e.stack
        ...
        function an(e, t, n) {
            ...
            if (e = e.style, n != null) {
                ...
                for (var a in t) t.hasOwnProperty(a) && rn(e, a, t[a])
        }
        ...
        function oc(e, t, n, r, i) {
            ...
            if (A) return t = uo.current, t === null ? (r !== Ki && (t = Error(s(423), {
                cause: r
            }), $i(Oi(t, n))), e = e.current.alternate, e.flags |= 65536, i &= -i, e.lanes |= i, r = Oi(r, n), i = rc(e.stateNode, r, i), $a(e, i), Y !== 4 && (Y = 2)) : (!(t.flags & 65536) && (t.flags |= 256), t.flags |= 65536, t.lanes = i, r !== Ki && (e = Error(s(422), {
                cause: r
            }), $i(Oi(e, n)))), !1;
            var a = Error(s(520), {
                cause: r
        ...
        function Ic(e, t, n) {
            ...
            switch (t.lanes = 0, t.tag) {
                ...
                case 3:
                    a: {
                        if (be(t, t.stateNode.containerInfo), e === null) throw Error(s(387));r = t.pendingProps;
                ...
                case 24:
                    return la(t), r = j(M), e === null ? (i = Ea(), i === null && (i = G, a = ha(), i.pooledCache = a, a.refCount++, a !== null && (i.pooledCacheLanes |= n), i = a), t.memoizedState = {
                        parent: r,
                        cache: i
...
`).replace(Ad, ``)
        ...
        function If(e, t, n) {
            if (t.count++, t.instance === null) switch (t.type) {
                ...
                case `script`:
                    return a = Pf(n.src), (i = e.querySelector(Ff(a))) ? (t.instance = i, O(i), i) : (r = n, (i = mf.get(a)) && (r = h({}, n), zf(r, i)), e = e.ownerDocument || e, i = e.createElement(`script`), O(i), Pd(i, `link`, r), e.head.appendChild(i), t.instance = i);
                case `void`:
                    return null;
                default:
    ...
    p = () => {
        let [e, t] = (0, l.useState)(!1), [n, r] = (0, l.useState)(!1), [i, a] = (0, l.useState)(`inicio`);
        (0, l.useEffect)(() => {
            let e = () => {
                r(window.scrollY > 50);
                for (let e of [`contacto`, `servicios`, `ia`, `nosotros`, `inicio`]) {
                    let t = document.getElementById(e);
                    if (t && t.getBoundingClientRect().top <= 150) {
                        a(e);
                        break
                    }
                }
        ...
        return (0, d.jsx)(`nav`, {
            className: `navbar ${n?`navbar--scrolled`:``}`,
            children: (0, d.jsxs)(`div`, {
                ...
                children: [(0, d.jsx)(`a`, {
                    ...
                    className: `navbar__hamburger ${e?`navbar__hamburger--active`:``}`,
                    onClick: o,
                    "aria-label": `Menú de navegación`,
                    "aria-expanded": e,
                    children: [(0, d.jsx)(`span`, {}), (0, d.jsx)(`span`, {}), (0, d.jsx)(`span`, {})]
                }), (0, d.jsxs)(`ul`, {
                    className: `navbar__menu ${e?`navbar__menu--open`:``}`,
                    children: [f.map(e => (0, d.jsx)(`li`, {
                        children: (0, d.jsx)(`a`, {
                            href: `#${e.id}`,
                            className: `navbar__link ${i===e.id?`navbar__link--active`:``}`,
                            onClick: () => s(e.id),
                            children: e.label
                        })
                    }, e.id)), (0, d.jsx)(`li`, {
                        children: (0, d.jsx)(`a`, {
                            href: `#contacto`,
                            className: `navbar__link navbar__link--cta ${i===`contacto`?`navbar__link--cta-active`:``}`,
                            onClick: () => s(`contacto`),
                            children: `Contacto`
                        })
                    })]
    ...
    m = () => (0, d.jsxs)(`section`, {
        ...
        children: [(0, d.jsx)(`div`, {
            ...
            children: [...Array(20)].map((e, t) => (0, d.jsx)(`div`, {
            ...
            children: [(0, d.jsx)(`div`, {
                ...
                children: (0, d.jsx)(`span`, {
                    children: `IA + Investigación Forense Veterinaria`
                })
            }), (0, d.jsxs)(`h1`, {
                className: `hero__title`,
                children: [`Animal Defense `, (0, d.jsx)(`span`, {
                    className: `hero__title-accent`,
                    children: `S.A.S`
                })]
            }), (0, d.jsxs)(`p`, {
                className: `hero__description`,
                children: [`Líderes en servicios médico legales y forenses veterinarios en Colombia, potenciados por `, (0, d.jsx)(`strong`, {
                    children: `inteligencia artificial`
                }), `. Desarrollo de software con IA para gestión forense animal, investigación criminal y prevención del delito en fauna doméstica, silvestre y animales de producción.`]
            }), (0, d.jsx)(`p`, {
                className: `hero__subdescription`,
                children: `Combinamos machine learning, analítica predictiva y experiencia científica para ofrecer soluciones que transforman la manera en que se protege la vida animal en instituciones públicas y privadas.`
            }), (0, d.jsxs)(`div`, {
                ...
                children: [(0, d.jsxs)(`div`, {
                    ...
                    children: [(0, d.jsx)(`span`, {
                        ...
                        className: `hero__stat-label`,
                        children: `Inteligencia artificial integrada`
                    })]
                }), (0, d.jsxs)(`div`, {
                    className: `hero__stat`,
                    children: [(0, d.jsx)(`span`, {
                        ...
                        className: `hero__stat-label`,
                        children: `Software con IA propietario`
                    })]
                })]
            })]
        }), (0, d.jsx)(`div`, {
    ...
    h = () => (0, d.jsx)(`section`, {
        ...
        children: (0, d.jsxs)(`div`, {
            ...
            children: [(0, d.jsx)(`h2`, {
                ...
                children: `Ciencia forense, inteligencia artificial e innovación al servicio del bienestar animal`
            }), (0, d.jsxs)(`div`, {
                ...
                children: [(0, d.jsxs)(`div`, {
                    ...
                    children: [(0, d.jsxs)(`p`, {
                        ...
                        children: [`Somos un equipo apasionado dedicado a la `, (0, d.jsx)(`strong`, {
                            children: `investigación forense veterinaria`
                        }), ` y la tecnología avanzada para el bienestar animal. Nuestra misión es proporcionar soluciones innovadoras y precisas que combinen la ciencia forense, la inteligencia artificial y la gestión estratégica para apoyar a las industrias pecuarias en la mejora de sus procesos y en la reducción de pérdidas económicas.`]
                    }), (0, d.jsx)(`p`, {
                        className: `about__text`,
                        children: `Con un enfoque integral, ayudamos a nuestros clientes a identificar las causas de mortalidad animal, optimizar la toma de decisiones estratégicas y garantizar la sostenibilidad en sus operaciones. Creemos en la importancia de la ética, la innovación y el compromiso para proteger la vida animal y fomentar entornos más seguros.`
                    }), (0, d.jsx)(`p`, {
                        className: `about__text`,
                        children: `Nuestro equipo multidisciplinario trabaja con rigor científico, utilizando las mejores prácticas internacionales y las herramientas más avanzadas para resolver los desafíos más complejos en el ámbito de la medicina veterinaria y la investigación forense.`
                    })]
                }), (0, d.jsxs)(`div`, {
                    ...
                    children: [(0, d.jsxs)(`div`, {
                        ...
                        children: [(0, d.jsx)(`div`, {
                            ...
                            className: `about__value-title`,
                            children: `Ética`
                        }), (0, d.jsx)(`p`, {
                            className: `about__value-desc`,
                            children: `Compromiso con los más altos estándares éticos en cada investigación`
                        })]
                    }), (0, d.jsxs)(`div`, {
                        className: `about__value`,
                        children: [(0, d.jsx)(`div`, {
                            ...
                            className: `about__value-title`,
                            children: `Innovación con IA`
                        }), (0, d.jsx)(`p`, {
                            className: `about__value-desc`,
                            children: `Inteligencia artificial, machine learning y analítica predictiva de vanguardia`
                        })]
                    }), (0, d.jsxs)(`div`, {
                        className: `about__value`,
                        children: [(0, d.jsx)(`div`, {
                            ...
                            className: `about__value-desc`,
                            children: `Dedicación absoluta a la protección de la vida animal`
                        })]
                    }), (0, d.jsxs)(`div`, {
                        className: `about__value`,
                        children: [(0, d.jsx)(`div`, {
                            ...
                            className: `about__value-title`,
                            children: `Rigor Científico`
                        }), (0, d.jsx)(`p`, {
                            className: `about__value-desc`,
                            children: `Mejores prácticas internacionales en cada análisis`
                        })]
                    })]
                })]
            })]
    ...
    g = [{
        icon: (0, d.jsxs)(`svg`, {
            ...
            strokeLinejoin: `round`,
            children: [(0, d.jsx)(`path`, {
                d: `M12 2a4 4 0 0 1 4 4c0 1.95-1.4 3.58-3.25 3.93L12 22`
            }), (0, d.jsx)(`path`, {
                d: `M12 2a4 4 0 0 0-4 4c0 1.95 1.4 3.58 3.25 3.93`
            }), (0, d.jsx)(`path`, {
                d: `M8.56 13.68C5.94 14.93 4 17.26 4 20h16c0-2.74-1.94-5.07-4.56-6.32`
            })]
        }),
    ...
    _ = () => (0, d.jsxs)(`section`, {
        ...
        children: [(0, d.jsxs)(`div`, {
            className: `ai-section__bg`,
            children: [(0, d.jsx)(`div`, {
                className: `ai-section__grid-lines`
            }), (0, d.jsx)(`div`, {
                className: `ai-section__glow ai-section__glow--1`
            }), (0, d.jsx)(`div`, {
                className: `ai-section__glow ai-section__glow--2`
            })]
        }), (0, d.jsxs)(`div`, {
            className: `container ai-section__container`,
            children: [(0, d.jsxs)(`div`, {
                className: `ai-section__header`,
                children: [(0, d.jsx)(`span`, {
                    className: `ai-section__label`,
                    children: `Tecnología de Vanguardia`
                }), (0, d.jsxs)(`h2`, {
                    className: `ai-section__title`,
                    children: [`Inteligencia Artificial al Servicio del `, (0, d.jsx)(`span`, {
                        children: `Bienestar Animal`
                    })]
                }), (0, d.jsx)(`p`, {
                    className: `ai-section__subtitle`,
                    children: `Nuestras plataformas AASIS® integran modelos avanzados de inteligencia artificial, machine learning y analítica de datos para transformar la forma en que se investigan y previenen los delitos contra los animales en Colombia.`
                })]
            }), (0, d.jsx)(`div`, {
                className: `ai-section__features`,
                children: g.map((e, t) => (0, d.jsxs)(`div`, {
                    className: `ai-feature`,
                    children: [(0, d.jsx)(`div`, {
                        className: `ai-feature__icon`,
                        children: e.icon
                    }), (0, d.jsx)(`h3`, {
                        className: `ai-feature__title`,
                        children: e.title
                    }), (0, d.jsx)(`p`, {
                        className: `ai-feature__desc`,
                        children: e.description
                    })]
                }, t))
            }), (0, d.jsx)(`div`, {
                className: `ai-section__cta-area`,
                children: (0, d.jsxs)(`div`, {
                    className: `ai-section__cta-content`,
                    children: [(0, d.jsx)(`div`, {
                        className: `ai-section__cta-badge`,
                        children: `IA + Ciencia Forense`
                    }), (0, d.jsx)(`h3`, {
                        className: `ai-section__cta-title`,
                        children: `La convergencia entre inteligencia artificial y medicina veterinaria forense`
                    }), (0, d.jsx)(`p`, {
                        className: `ai-section__cta-text`,
                        children: `Animal Defense S.A.S. lidera la integración de IA en la investigación forense veterinaria en Latinoamérica. Nuestros algoritmos procesan miles de datos en segundos, detectan anomalías que el ojo humano no puede ver y generan insights accionables que salvan vidas animales y reducen pérdidas económicas significativas.`
                    }), (0, d.jsxs)(`div`, {
                        className: `ai-section__cta-stats`,
                        children: [(0, d.jsxs)(`div`, {
                            className: `ai-section__cta-stat`,
                            children: [(0, d.jsx)(`span`, {
                                className: `ai-section__cta-stat-number`,
                                children: `95%`
                            }), (0, d.jsx)(`span`, {
                                className: `ai-section__cta-stat-label`,
                                children: `Precisión en predicciones`
                            })]
                        }), (0, d.jsxs)(`div`, {
                            className: `ai-section__cta-stat`,
                            children: [(0, d.jsx)(`span`, {
                                ...
                                className: `ai-section__cta-stat-label`,
                                children: `Más rápido que análisis manual`
                            })]
                        }), (0, d.jsxs)(`div`, {
                            className: `ai-section__cta-stat`,
                            children: [(0, d.jsx)(`span`, {
                                ...
                                className: `ai-section__cta-stat-label`,
                                children: `Monitoreo inteligente continuo`
                            })]
                        })]
                    }), (0, d.jsx)(`a`, {
                        href: `#contacto`,
                        className: `ai-section__cta-btn`,
                        children: `Descubra el poder de la IA`
                    })]
                })
            })]
        })]
    ...
    v = [{
        ...
        image: `/LOGO AASIS PLANTAS DE BENEFICIO.png`
    }, {
        id: 7,
        category: `aasis`,
        ...
        image: `/LOGO AASIS BIENESTAR ANIMAL.png`
    }],
    y = [{
        key: `todos`,
        label: `Todos`
    ...
    b = () => {
        let [e, t] = (0, l.useState)(`todos`), n = e === `todos` ? v : v.filter(t => t.category === e);
        return (0, d.jsx)(`section`, {
            ...
            children: (0, d.jsxs)(`div`, {
                ...
                children: [(0, d.jsx)(`h2`, {
                    ...
                    className: `section-subtitle`,
                    children: `Soluciones integrales con inteligencia artificial en investigación forense veterinaria`
                }), (0, d.jsx)(`div`, {
                    className: `services__filters`,
                    children: y.map(n => (0, d.jsx)(`button`, {
                        className: `services__filter ${e===n.key?`services__filter--active`:``}`,
                        onClick: () => t(n.key),
                        children: n.label
                    }, n.key))
                }), (0, d.jsx)(`div`, {
                    className: `services__grid`,
                    children: n.map(e => (0, d.jsxs)(`div`, {
                        className: `services__card`,
                        children: [e.image ? (0, d.jsx)(`div`, {
                            className: `services__card-logo`,
                            children: (0, d.jsx)(`img`, {
                                src: e.image,
                                alt: e.title
                            })
                            ...
                            className: `services__card-desc`,
                            children: e.description
                        }), (0, d.jsx)(`div`, {
                            className: `services__card-tag`,
                            children: e.category === `aasis` ? `IA + Software` : `Forense`
                        })]
                    }, e.id))
                })]
            })
        ...
        return (0, d.jsx)(`section`, {
            ...
            children: (0, d.jsxs)(`div`, {
                ...
                children: [(0, d.jsx)(`h2`, {
                    ...
                    className: `section-subtitle`,
                    children: `Utilice el siguiente formulario para solicitar más información`
                }), (0, d.jsxs)(`div`, {
                    ...
                    children: [(0, d.jsxs)(`div`, {
                        ...
                        children: [(0, d.jsxs)(`div`, {
                            ...
                            children: [(0, d.jsx)(`div`, {
                                ...
                                children: [(0, d.jsx)(`h3`, {
                                    ...
                                    href: `tel:+573185568832`,
                                    className: `contact__info-text`,
                                    children: `+57 318 5568832`
                                })]
                            })]
                        }), (0, d.jsxs)(`div`, {
                            className: `contact__info-card`,
                            children: [(0, d.jsx)(`div`, {
                                ...
                                children: [(0, d.jsx)(`h3`, {
                                    ...
                                    href: `mailto:animaldefensecol@gmail.com`,
                                    className: `contact__info-text`,
                                    children: `animaldefensecol@gmail.com`
                                })]
                            })]
                        }), (0, d.jsxs)(`div`, {
                            className: `contact__info-card`,
                        ...
                        onSubmit: t => {
                            t.preventDefault();
                            let n = `mailto:animaldefensecol@gmail.com?subject=${encodeURIComponent(e.subject)}&body=${encodeURIComponent(`Nombre: ${e.name}\nEmail: ${e.email}\n\n${e.message}`)}`;
                ...
                children: [(0, d.jsxs)(`div`, {
                    ...
                    children: [(0, d.jsxs)(`div`, {
                        ...
                        children: [(0, d.jsx)(`div`, {
                            ...
                            children: `Líderes en servicios médico legales y forenses veterinarios en Colombia. Tecnología avanzada y experiencia científica al servicio del bienestar animal.`
                        })]
                    }), (0, d.jsxs)(`div`, {
                    ...
                    children: [(0, d.jsxs)(`p`, {
                        children: [`Copyright © `, e, ` Animal Defense S.A.S. Todos los derechos reservados.`]
                    }), (0, d.jsx)(`p`, {
                        className: `footer__credits`,
                        children: `Desarrollado por Eval Ingeniería`
                    })]
                })]
            })
        })
...
function S() {
    return (0, d.jsxs)(d.Fragment, {
        children: [(0, d.jsx)(p, {}), (0, d.jsx)(m, {}), (0, d.jsx)(h, {}), (0, d.jsx)(_, {}), (0, d.jsx)(b, {}), (0, d.jsx)(x, {}), (0, d.jsx)(ee, {})]
    })
}(0, c.createRoot)(document.getElementById(`root`)).render((0, d.jsx)(l.StrictMode, {
    children: (0, d.jsx)(S, {})
}));
